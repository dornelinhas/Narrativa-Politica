...
const vueContent = `<template>
  <div class="contact-page">
      ...
      <div v-if="isSubmitted" class="success-overlay">
        <div class="success-card">
          ...
          <div class="success-icon-box">
            <Check class="text-white" :size="40" stroke-width="3" />
          </div>
    ...
    <div :class="{ 'submitted-state': isSubmitted }">
      ...
      <!-- HERO: PREMIUM BRUTALIST -->
      <section class="premium-hero pt-32 md:pt-48">
        <div class="marquee-bg">
          <div class="marquee-track">
            <span>ENVOLVA-SE • IMPACTE • MOBILIZE • ENVOLVA-SE • IMPACTE • MOBILIZE • ENVOLVA-SE • IMPACTE • MOBILIZE • </span>
            <span>ENVOLVA-SE • IMPACTE • MOBILIZE • ENVOLVA-SE • IMPACTE • MOBILIZE • ENVOLVA-SE • IMPACTE • MOBILIZE • </span>
          </div>
        </div>
        <div class="container-max relative z-10 text-center hero-content">
          <div class="hero-badge mx-auto mb-8 mt-12">
            <Sparkles :size="16" />
        ...
        <div class="premium-cards-grid">
          ...
          <div class="premium-card bg-amarelo">
            ...
            <div class="pc-body">
              ...
              <p class="pc-desc text-black">Receba análises políticas profundas e atualizações do movimento direto na sua caixa de entrada.</p>
            </div>
            <a href="#" class="pc-btn">
          ...
          <!-- CARD 2 -->
          <div class="premium-card bg-rosa">
            <div class="pc-header">
              <span class="pc-number outlined-light">02</span>
              <div class="pc-icon-wrapper"><Users :size="32" /></div>
            </div>
            <div class="pc-body">
              <h3 class="pc-title text-white">SEJA PARCEIRO</h3>
              <p class="pc-desc text-white">Junte sua organização à nossa rede para construirmos campanhas e projetos de impacto estrutural.</p>
            </div>
            <a href="#" class="pc-btn btn-light">
          ...
          <div class="premium-card bg-verde">
            ...
            <div class="pc-body">
              ...
              <p class="pc-desc text-black">Sua contribuição financeira é fundamental para mantermos nossa independência e ampliarmos nosso alcance.</p>
            </div>
            <router-link to="/apoie" class="pc-btn">
      ...
      <!-- INFOS DE RODAPÉ -->
      <section class="footer-contact-section pb-24">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mt-16 px-6">
            <div class="bg-white border-[3px] border-black p-8 rounded-[2rem] flex items-center gap-6 shadow-[8px_8px_0_0_rgba(0,0,0,1)]">
              ...
              <div>
                ...
                <a href="mailto:contato.narrativapolitica@gmail.com" class="font-black md:text-lg text-sm hover:text-[#FF3C82] transition-colors">contato.narrativapolitica@gmail.com</a>
              </div>
            </div>
            <div class="bg-white border-[3px] border-black p-8 rounded-[2rem] flex items-center gap-6 shadow-[8px_8px_0_0_rgba(0,0,0,1)]">
...
import { Mail, ArrowRight, Heart, Users, Sparkles, Send, Check } from 'lucide-vue-next';
...
.pc-btn.btn-light {
  background-color: var(--np-white, #FFFFFF);
  color: var(--np-black, #1C1C1C);
  border-color: var(--np-white, #FFFFFF);
}

.pc-btn.btn-light:hover {
  background-color: transparent;
  color: var(--np-white, #FFFFFF);
}
...
fs.writeFileSync('src/views/ContactView.vue', vueContent, 'utf8');
console.log('ContactView.vue completely restored!');
